...
//     std::cout << "Calendar UI Constructor" << std::endl;
//     setFixedSize(700, 500);
//     setupUI();
//     updateCalendar();
// }
...
// CalendarUI::~CalendarUI()
// {
//     std::cout << "Calendar UI Destructor" << std::endl;
// }
...
//     {
//         dayBtn->hide();
//         dayBtn->disconnect();  // Disconnect old connections
//     }
...
//         // Bind click signal directly with the day value
