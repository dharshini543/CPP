...
Rental_Vehicle_Manager::Rental_Vehicle_Manager()
{
    int userCount = 0;
    cout<<"Rental_Vehicle_Manager Constructor"<<endl;
...
Rental_Vehicle_Manager::Rental_Vehicle_Manager(const Rental_Vehicle_Manager &manager)
{
    cout<<"Rental_Vehicle_Manager copy Constructor"<<endl;
}
...
Rental_Vehicle_Manager Rental_Vehicle_Manager::operator =(Rental_Vehicle_Manager &manager)
{
    cout<< "Rental_Vehicle_Manager assignment operator"<<endl;
    return manager;
}

int Rental_Vehicle_Manager::main_menu()
{
...
void Rental_Vehicle_Manager::addBike()
{
...
void Rental_Vehicle_Manager::addCar()
{
...
void Rental_Vehicle_Manager::addCustomer(string vehicleName,string vehicleModel,string vehicleStatus,float vehicleCost,string vehicleNumber)
{
...
void Rental_Vehicle_Manager::deleteBike()
{
...
void Rental_Vehicle_Manager::deleteCar()
{
...
void Rental_Vehicle_Manager::searchBike()
{
    string bikeName,bikeNumber;
    int bikeFound = 0;
    while(true)
...
void Rental_Vehicle_Manager::searchCar()
{
    string carName,carNumber;
    int carFound = 0;
    while(true)
...
void Rental_Vehicle_Manager::sortByCarPrice()
{
...
void Rental_Vehicle_Manager::sortByCarName()
{
    m_carList.sort([](RentalCarDetails* a, RentalCarDetails* b) {
...
void Rental_Vehicle_Manager::sortByCarStatus()
{
    m_carList.sort([](RentalCarDetails* a, RentalCarDetails* b) {
...
void Rental_Vehicle_Manager::sortByBikePrice()
{
...
void Rental_Vehicle_Manager::sortByBikeName()
{
    m_bikeList.sort([](RentalBikeDetails* a, RentalBikeDetails* b) {
        return a->getVehicleName() > b->getVehicleName();
    });
...
void Rental_Vehicle_Manager::sortByBikeStatus()
{
    m_bikeList.sort([](RentalBikeDetails* a, RentalBikeDetails* b) {
        return a->getVehicleStatus() > b->getVehicleStatus();
    });
...
void Rental_Vehicle_Manager::writeDataToFile()
{
    m_bikeFO->writeData(m_bikeList);
    m_carFO->writeData(m_carList);
    m_cusFO->writeData(m_customerList);
...
void Rental_Vehicle_Manager::bookBike()
{
    string bikeName, bikeNumber;
    int bikeFound = 0;
...
void Rental_Vehicle_Manager::bookCar()
{
    string carName,carNumber;
    int carFound = 0;
...
void Rental_Vehicle_Manager::returnBike()
{
    string bikeName,bikeNumber;
    int success = 0;
...
void Rental_Vehicle_Manager::returnCar()
{
    string carName,carNumber;
    int success = 0;
...
void Rental_Vehicle_Manager::displayBikeList()
{
    cout<<"bikeName";
    cout.width(20);
    cout<<"bikeModel";
...
void Rental_Vehicle_Manager::displayCarList()
{
    cout<<"carName";
    cout.width(30);
    cout<<"carModel";
...
void Rental_Vehicle_Manager::displayCustomerList()
{
    cout<<"CustomerName ";
    cout.width(10);
    cout<<"BookingID ";
...
void Rental_Vehicle_Manager::updateBikeCost()
{
    float bikeNewAmount;
...
void Rental_Vehicle_Manager::updateCarCost()
{
    float CarnewAmount;
...
int Rental_Vehicle_Manager::payment(float balanceAmount)
{
    ...
    if(choice == 1)
    {
        ...
        {
            cout<<"Please pay full amount to return"<<endl;
            success = this->payment(balanceAmount);
        }
