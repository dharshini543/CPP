#ifndef RENTAL_VEHICLE_MANAGER_H
#define RENTAL_VEHICLE_MANAGER_H
...
class Rental_Vehicle_Manager
{
public:
    Rental_Vehicle_Manager();
    Rental_Vehicle_Manager(const Rental_Vehicle_Manager &manager);
    ~Rental_Vehicle_Manager();

    Rental_Vehicle_Manager operator = (Rental_Vehicle_Manager& manager );
...
#endif // RENTAL_VEHICLE_MANAGER_H
